    ...
    <Section className="flex flex-col gap-4 items-start">
      ...
      <div className="flex max-md:flex-col gap-4">
        ...
        <div className="flex flex-col gap-2 flex-1 w-full">
          ...
          <p className="text-sm text-muted-foreground">
            Pour être flexible sur votre design tout en étant responsive.
          </p>
        </div>
        <div className="flex flex-col gap-2 flex-1 w-full">
          ...
          <p className="text-sm text-muted-foreground">
            Le tout en utilisant<Highlights>Typescript</Highlights>, pour
        ...
        <div className="flex flex-col gap-2 flex-1 w-full">
          ...
          <p className="text-sm text-muted-foreground">
            L&apos;intelligence artificielle, pour gagner en efficacité.
          </p>
        </div>
      </div>
    </Section>
